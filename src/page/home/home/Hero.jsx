...
<p href="#_" className="px-10 py-1 relative rounded group  text-white font-medium inline-block">
...
<span className="relative"><Link to={'/product'}>Explore More</Link></span>
</p>
